...
export enum AssetKey {
  ...
  FeedbackTopBanner = 'feedback-success-top-banner',
  CheckInSuccessTopBanner = 'check-in-success-top-banner',
  CheckInSuccessMap = 'check-in-success-map',
  CheckInSuccessAgenda = 'check-in-success-agenda',
}
